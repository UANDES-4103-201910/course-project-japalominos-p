class FileAttachmentsController < ApplicationController
  ...
  def create
    ...
    @file_attachment = @post.file_attachments.new(file_attachment_params)
  ...
  def destroy
    @post = Post.find(params[:post_id])
    @file_attachments = @post.file_attachments.find(params[:id])
  ...
  private
    ...
    def file_attachment_params
      params.require(:file_attachment).permit(:url)
    end
end
