...
class BlacklistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create blacklist" do
    assert_difference('Blacklist.count') do
      post blacklists_url, params: { blacklist: { date_suspended: @blacklist.date_suspended } }
    end
  ...
  test "should update blacklist" do
    patch blacklist_url(@blacklist), params: { blacklist: { date_suspended: @blacklist.date_suspended } }
